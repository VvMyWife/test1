...
result = extract_pdf(
    "/home/kaifang/mineru_workspace/input/example.pdf",
    output_dir="/home/kaifang/mineru_workspace/output/example",
    api_url="http://127.0.0.1:8000",
    timeout_seconds=1800,
)

Path("/home/kaifang/mineru_workspace/output/example.json").write_text(
...
curl -X POST http://127.0.0.1:8001/api/v1/operators/mineru/layout-extract-path \
  ...
  -d '{
    "pdf_path": "/home/kaifang/mineru_workspace/input/example.pdf",
...
curl \
  ...
  -F "output_dir=/home/kaifang/mineru_workspace/output" \
...
```json
{
  "success": true,
  "data": {
    "source_pdf": "/home/kaifang/mineru_workspace/input/example.pdf",
    "source_file_name": "example.pdf",
    "success": true,
    "json_path": "/home/kaifang/mineru_workspace/output/example.json",
    "artifact_dir": "/home/kaifang/mineru_workspace/output/example",
    "page_count": 10,
    "text_block_count": 81,
    "table_block_count": 0,
